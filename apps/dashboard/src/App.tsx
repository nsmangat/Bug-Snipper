...
function App() {
  return (
    <Routes>
      ...
      This is so :workspaceId param can be gotten by the 3 child routes inside the path="/workspaces/:workspaceId" route
      */}
        <Route
          path="/"
        ...
        <Route path="/workspaces/:workspaceId">
          {/*3 child routes being referred to in above comment*/}
